...
<html lang="en">
  <head>
    ...
    <title>Auth Form | Cash Plus</title>
      ...
      * {
      ...
      @media (max-width: 768px) {
        ...
        .mobile-switch-btn {
          ...
          border: 1px solid rgb(36, 211, 211);
  ...
  <body>
    <div class="form-container" id="formContainer">
      ...
      <div class="left-panel" id="leftPanel">
        <div class="panel-content" id="leftPanelContent">
          <img
            class="logo"
            src="https://images.teamtailor-cdn.com/images/s3/teamtailor-production/logotype-v3/image_uploads/cd1e379b-6470-48a9-acdb-c84c4b24c21f/original.png"
            alt="Cash Plus Logo"
          />
          <p id="welcomeText">Hello, Welcome!</p>
      ...
      <div class="right-panel" id="rightPanel">
        ...
        >
          <div class="panel-content">
            ...
            (errorMessage != null) { %>
            <div
              class="bg-red-100 text-red-700 p-3 rounded-md mb-4 text-sm font-medium"
            >
              <%= errorMessage %>
            </div>
            <% session.removeAttribute("error"); // Remove error after
            displaying } %> <% String message = (String)
            session.getAttribute("message"); String error = (String)
            session.getAttribute("error"); if (message != null) { %>
            <div
              class="text-[rgba(36,211,211,1)] border border-[rgba(36,211,211,1)] p-3 rounded-md mb-4"
            >
              <%= message %>
            </div>
            ...
            if (error != null) { %>
            <div
              class="bg-red-100 text-red-700 border border-red-400 p-3 rounded-md mb-4"
            >
              <%= error %>
            </div>
    ...
    <script>
      ...
      loginForm.addEventListener("submit", function (e) {
        ...
        // Form will submit normally unless validation fails
      });
      ...
      // Switch forms with smooth transitions
      function toggleForms() {
        ...
        if (isSignup) {
          welcomeText.textContent = "Welcome Back!"; // Changed to show with login form
          accountPrompt.textContent = "Already have an account?";
          switchBtn.textContent = "Sign In";
        } else {
          welcomeText.textContent = "Hello, Welcome!"; // Changed to show with signup form
          accountPrompt.textContent = "Don't have an account?";
          switchBtn.textContent = "Register";
        }

        // Fade in new form after a slight delay
        setTimeout(() => {
          if (isSignup) {
